    ...
    return [
        {
            ...
            description: 'Retrieve aggregate performance metrics and system-wide statistics in JSON format. Use for monitoring overall application health, trends, and high-level performance overview (use get_traces for detailed individual request analysis).',
            inputSchema: {
                type: 'object',
                properties: {
                    ts: {
        ...
        },
        {
            ...
            description: 'Retrieve time-series performance summary data in 15-minute intervals in JSON format for trend analysis and historical comparison. Returns data aggregated in 15-minute time buckets showing requests, errors, and 95th percentile response times.',
            inputSchema: {
                type: 'object',
                properties: {
                    s: {
        ...
        {
            name: 'get_traces',
            description: 'Analyze individual trace samples in JSON format for detailed bottleneck identification and performance debugging. Use for investigating specific slow requests, not system-wide statistics (use get_performance_metrics for aggregate data).',
            inputSchema: {
                type: 'object',
                properties: {
                    env: {
                    ...
                    min_date: {
                        type: 'string',
                        description: 'Minimal date for traces in YYYY-MM-DD HH:MM format (e.g., "2024-01-15 14:30"). Convert natural language like "1 hour ago" to this format. Requires max_date.',
                    },
                    max_date: {
                        type: 'string',
                        description: 'Maximal date for traces in YYYY-MM-DD HH:MM format (e.g., "2024-01-15 16:30"). Convert natural language like "now" to this format. Requires min_date.',
                    },
        ...
        },
        {
            ...
            description: 'Fetch the full detail of a single trace by ID, including callgraph spans, custom annotations, SQL queries, cache calls, and timing breakdown per layer. Use after get_traces to drill into a specific slow request.',
            inputSchema: {
                type: 'object',
                properties: {
                    trace_id: {
        ...
        },
        {
            ...
            description: 'Fetch the full detail of a single error or issue by ID, including complete stack traces, affected transactions, and occurrence history. Use after get_issues to drill into a specific error.',
            inputSchema: {
                type: 'object',
                properties: {
                    error_id: {
